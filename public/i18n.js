    ...
    cs: {
      ...
      marketing: {
        ...
        faq: [
          ...
          { q: "V jakém jazyce chatbot odpovídá?", a: "Podle jazyka zákazníka — appka odpovídá ve stejném jazyce, ve kterém se zákazník zeptá, ať už česky, anglicky, německy nebo jinak. Odpovídá jen na základě reálných dat z vašeho obchodu, nic si nevymyšlí." },
        ],
      ...
      dashboard: {
        ...
        testWidgetLink: "Vyzkoušet widget na testovací stránce →",
    ...
    en: {
      ...
      marketing: {
        ...
        faq: [
          ...
          { q: "How much does it cost?", a: "Five self-service plans with a fixed monthly price, not a charge per message: Start 70 for 379 CZK, Basic 150 for 779 CZK, Growth 400 for 1,570 CZK, Pro 1000 for 3,490 CZK, and Business 5000 for 7,990 CZK. The number in the name is the monthly limit of resolved cases, not the price of one. Higher plans are available on request for larger traffic." },
          ...
          { q: "What language does the chatbot reply in?", a: "Whatever language the customer asks in — the app replies in the same language, whether Czech, English, German or anything else. It only answers based on real data from your store — it never makes anything up." },
        ],
      ...
      dashboard: {
        ...
        testWidgetLink: "Try the widget on a test page →",
    ...
    sk: {
      ...
      marketing: {
        ...
        faq: [
          ...
          { q: "Koľko to stojí?", a: "Päť samoobslužných tarifov s pevnou mesačnou cenou, nie platbou za jednotlivú správu: Start 70 za 379 Kč, Basic 150 za 779 Kč, Growth 400 za 1 570 Kč, Pro 1000 za 3 490 Kč a Business 5000 za 7 990 Kč. Číslo v názve je mesačný limit vyriešených prípadov, nie cena za jeden. Pre väčšiu prevádzku sú k dispozícii aj vyššie tarify na vyžiadanie." },
          ...
          { q: "V akom jazyku chatbot odpovedá?", a: "Podľa jazyka zákazníka — appka odpovedá v rovnakom jazyku, v akom sa zákazník opýta, či už po česky, anglicky, nemecky alebo inak. Odpovedá len na základe reálnych dát z vášho obchodu, nič si nevymyšľa." },
        ],
      ...
      dashboard: {
        ...
        testWidgetLink: "Vyskúšať widget na testovacej stránke →",
        billingHeading: "Tarif a platba",
    ...
    de: {
      ...
      marketing: {
        ...
        faq: [
          ...
          { q: "Was kostet das?", a: "Fünf Self-Service-Tarife mit festem Monatspreis, keine Abrechnung pro Nachricht: Start 70 für 379 CZK, Basic 150 für 779 CZK, Growth 400 für 1.570 CZK, Pro 1000 für 3.490 CZK und Business 5000 für 7.990 CZK. Die Zahl im Namen ist das monatliche Limit gelöster Fälle, nicht der Preis für einen einzelnen. Für höheres Volumen sind auf Anfrage auch größere Tarife verfügbar." },
          ...
          { q: "In welcher Sprache antwortet der Chatbot?", a: "In der Sprache, in der der Kunde fragt — die App antwortet in derselben Sprache, ob Tschechisch, Englisch, Deutsch oder eine andere. Sie antwortet nur auf Basis echter Daten aus Ihrem Shop und erfindet nichts." },
        ],
      ...
      dashboard: {
        ...
        testWidgetLink: "Widget auf einer Testseite ausprobieren →",
    ...
    pl: {
      ...
      marketing: {
        ...
        faq: [
          ...
          { q: "W jakim języku odpowiada chatbot?", a: "W języku, w którym pyta klient — aplikacja odpowiada w tym samym języku, czy to po czesku, angielsku, niemiecku, czy w innym. Odpowiada wyłącznie na podstawie rzeczywistych danych z Twojego sklepu, niczego nie zmyśla." },
        ],
      ...
      dashboard: {
        ...
        testWidgetLink: "Wypróbuj widget na stronie testowej →",
